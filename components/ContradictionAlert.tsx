            ...
            <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '14px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                        <IconAlertTriangle size={20} color="var(--red)" />
                        <span
                            style={{
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                    <div
                        style={{
                            background: 'rgba(var(--glass-red),0.06)',
                            border: '1px solid rgba(var(--glass-red),0.2)',
                            borderRadius: '8px',
                            padding: '12px 16px',
                        }}
                    >
                    ...
                    <div
                        style={{
                            background: 'rgba(var(--glass-red),0.1)',
                            border: '1px solid rgba(var(--glass-red),0.3)',
                            borderRadius: '8px',
                            padding: '12px 16px',
                        }}
                    >
