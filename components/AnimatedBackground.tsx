...
export default function AnimatedBackground() {
    ...
    useEffect(() => {
        ...
        const draw = () => {
            ...
            grd.addColorStop(0, 'rgba(var(--glass-accent),0.13)');
            grd.addColorStop(0.5, 'rgba(var(--glass-accent),0.04)');
            ...
            // Animated grid lines
            ctx.strokeStyle = 'rgba(var(--glass-accent),0.035)';
            ctx.lineWidth = 1;
            ...
            particles.forEach(p => {
                ...
                ctx.fillStyle = `rgba(var(--glass-accent),${Math.max(0, alpha)})`;
                ctx.fill();
            });
            ...
            for (let i = 0; i < particles.length; i++) {
                for (let j = i + 1; j < particles.length; j++) {
                    ...
                    if (dist < 130) {
                        ...
                        ctx.strokeStyle = `rgba(var(--glass-accent),${alpha})`;
                        ctx.lineWidth = 0.5;
                        ctx.stroke();
                    }
                }
